...
export const metadata: Metadata = {
  title: "Liên hệ & Đặt bàn — LOCO Complex · 0905 806 518",
  description:
    "Đặt bàn LOCO Complex qua form, hotline 0905 806 518 hoặc Zalo. Địa chỉ: 11 Nam Quốc Cang, Phạm Ngũ Lão, Quận 1, TP.HCM. Mở cửa 22:00 – 05:00.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Hotline 0905 806 518 · Zalo · Form đặt bàn. 11 Nam Quốc Cang, Q.1.",
    url: "/lien-he",
    locale: "vi_VN",
    type: "website",
  ...
  twitter: {
    ...
    description: "Đặt bàn · Hotline 0905 806 518 · Zalo",
    images: ["/og.jpg"],
  },
};
