...
export const metadata: Metadata = {
  ...
  description:
    "LOCO Complex — khu phức hợp giải trí phong cách NEWTRO tại 11 Nam Quốc Cang, Quận 1, Sài Gòn. 2 tầng club: Heatroom (EDM, Top 40, House) + Hip-hop. F&B by BITES. Mở cửa 22:00 – 05:00. Đặt bàn: 091 4271 564.",
  keywords: [
    "LOCO Complex",
    "LOCO Heatroom",
    "LOCO Quận 1",
  ...
  openGraph: {
    ...
    description:
      "Khu phức hợp giải trí phong cách NEWTRO tại 11 Nam Quốc Cang, Quận 1. 2 tầng club: Heatroom (EDM, Top 40, House) + Hip-hop. F&B by BITES. Đặt bàn: 091 4271 564.",
  ...
  twitter: {
    ...
    title: "LOCO Complex — Khu Giải Trí & Âm Nhạc · Quận 1, Sài Gòn",
    description:
      "Khu phức hợp giải trí NEWTRO · 2 tầng club · F&B by BITES · Đặt bàn 091 4271 564",
    images: ["/og.jpg"],
  },
  icons: {
    icon: [
