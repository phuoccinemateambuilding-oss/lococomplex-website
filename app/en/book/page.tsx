...
export const metadata: Metadata = {
  ...
  description:
    "Book LOCO Complex online — NEWTRO-style entertainment complex at 11 Nam Quoc Cang, District 1, Saigon. 2-floor club: Heatroom (EDM, Top 40, House) + Hip-hop. Open 6 PM – 12 AM. Hotline 0866 433 754.",
  alternates: {
    canonical: "/en/book",
    languages: {
      vi: "/dat-ban",
  ...
  openGraph: {
    ...
    description:
      "Book LOCO Complex — 2-floor club Heatroom + Hip-hop at 11 Nam Quoc Cang, D.1. Open 6 PM – 12 AM. Hotline 0866 433 754.",
    url: "/en/book",
  },
};
