...
export const metadata: Metadata = {
  ...
  description:
    "LOCO Complex — NEWTRO-style entertainment complex at 11 Nam Quoc Cang, District 1, Saigon. 2-floor club: Heatroom (EDM, Top 40, House) + Hip-hop. Dining by BITES. Open 10:00 PM – 5:00 AM. Book a table: 0338 411 908.",
  keywords: [
    "LOCO Complex",
    "LOCO Heatroom",
    "LOCO District 1",
  ...
  openGraph: {
    ...
    title: "LOCO Complex — Entertainment & Music Venue · District 1, Saigon",
    description:
      "NEWTRO-style entertainment complex at 11 Nam Quoc Cang. 2-floor club (Heatroom · Hip-hop) + BITES F&B. Book: 0338 411 908.",
  ...
  twitter: {
    ...
    description: "NEWTRO entertainment · 2-floor club · BITES F&B · Book 0338 411 908",
    images: ["/og.jpg"],
  },
};
