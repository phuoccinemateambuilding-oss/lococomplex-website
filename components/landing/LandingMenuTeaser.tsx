  ...
  return (
    <section id="menu" className="relative scroll-mt-20 border-t border-white/5 bg-midnight py-14 md:scroll-mt-24 md:py-20">
      ...
      <div className="relative mx-auto max-w-[1400px] px-5 md:px-10">
        ...
        <div className="relative mx-auto max-w-sm md:max-w-md overflow-hidden rounded-3xl border border-loco-yellow/20 bg-midnight-deep shadow-[0_20px_60px_-15px_rgba(245,195,48,0.15)]">
