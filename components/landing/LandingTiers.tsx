  ...
  return (
    <section id="tiers" className="relative scroll-mt-20 border-t border-white/5 bg-midnight py-14 md:scroll-mt-24 md:py-20">
      <div className="mx-auto max-w-[1400px] px-5 md:px-10">
          ...
          {items.map((tier, i) => (
            ...
            >
              ...
              <div className="flex flex-1 flex-col p-5">
                ...
                <p className="mb-4 font-[family-name:var(--font-space-mono)] text-base font-bold text-loco-yellow md:text-lg">
                  {tier.price}
                </p>
        ...
        <p className="mt-8 text-center font-[family-name:var(--font-space-mono)] text-xs text-white/50 md:text-sm">
          {dict.footnote}
        </p>
      </div>
    </section>
